...
typedef enum {
    TK_FUNC_KW, TK_IF_KW, TK_ELSE_KW, TK_IDENT, TK_NUM_LITERAL, TK_ASSIGN, TK_ADD, TK_SUB, TK_EQU, TK_NON_EQU, TK_OPEN_BRACE, TK_CLOSE_BRACE, TK_OPEN_PAREN, TK_CLOSE_PAREN,
} Token_Type;
